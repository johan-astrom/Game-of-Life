...
namespace GameOfLife.Tests
{
    public class GameRulesTest
    {
        ...
        {
            TestContext.Write("Asserting that MaxYCoordinate returns biggest x-axis value after Parse is called.");
        ...
        {
            TestContext.Write("Asserting that MaxYCoordinate returns biggest y-axis value after Parse is called.");
